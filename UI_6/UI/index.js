    ...
    var drawing = function () {
        ...
        */
        ...
        for (var i = 0; i < observableArray.length - 1; i++) {
            ...
            if (observableArray[i].z != null && observableArray[i].a != null && observableArray[i].MD != null)
            line = renderer.line(Number(observableArray[i].z) + 115, (-1 * Number(observableArray[i].a) + 115),
                Number(observableArray[i + 1].z) + 115, (-1 * Number(observableArray[i + 1].a) + 115),
                {
                    stroke: constcolor
                    //stroke: color[i]
                });
        ...
        for (var i = 0; i < observableArray.length - 1; i++) {
            ...
            line = renderer2.line(Number(observableArray[i].MD) + 115, (-1 * Number(observableArray[i].z) + 115),
                            Number(observableArray[i + 1].MD) + 115, (-1 * Number(observableArray[i + 1].z) + 115),
                            {
                                stroke: constcolor
                                //stroke: color[i]
                            });

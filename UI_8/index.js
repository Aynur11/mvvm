$(document).ready(function ()
{
    ...
    function DrawingGraph(cartesianWellSurveyItems)
    {
        ...
        {
            renderer.line(Number(cartesianWellSurveyItems[i].x) + halfSize, (-1 * Number(cartesianWellSurveyItems[i].y) + halfSize),
                    Number(cartesianWellSurveyItems[i + 1].x) + halfSize, (-1 * Number(cartesianWellSurveyItems[i + 1].y) + halfSize),
                {
                    stroke: color
                });
            renderer2.line(Number(cartesianWellSurveyItems[i].z) + halfSize, (-1 * Number(cartesianWellSurveyItems[i].x) + halfSize),
                Number(cartesianWellSurveyItems[i + 1].z) + halfSize, (-1 * Number(cartesianWellSurveyItems[i + 1].x) + halfSize),
                            {
                                stroke: color
                            });
        }
    ...
    {
        cartesian[index].x = spherical[index]._MD * Math.sin(spherical[index]._Z) * Math.cos(spherical[index]._A);
        cartesian[index].y = spherical[index]._MD * Math.sin(spherical[index]._Z) * Math.sin(spherical[index]._A);
        cartesian[index].z = spherical[index]._MD * Math.cos(spherical[index]._Z);
